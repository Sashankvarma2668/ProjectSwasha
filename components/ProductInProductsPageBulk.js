...
const ProductInProductsPage = (props) => {
  return (
    ...
    <div className="p-10  bg-gray-100 xl:px-9  bg-white rounded-3xl">
    <a href="#">
      <img className="mb-8 xl:mb-4 mx-auto h-40 object-cover" src={props.image} alt=""/>
    </a>
    <Link href={"/ProductInfoBulk/" + props.id}>
    <a href="#">
      <p className="lg:h-14 text-xl text-center leading-8 font-heading font-medium hover:underline ">{props.description}</p>
    </a>
    </Link>
