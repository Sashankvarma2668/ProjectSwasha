...
import EmptyWishlist from "..//../public/lottie/empty_wishlist.json";
...
const Index = () => {
  ...
  const AddToCartList = () => {
    axios
      .post(API_URL + "/wishlist/wishlist_to_cart_full.php", {
        studentid: studentid,
      })
      .then(function (response) {
        if (response) {
        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap -mx-4 mb-14 xl:mb-24">
            <div className="w-full md:w-8/12 xl:w-9/12 px-4 mb-14 md:mb-0">
              <div className="py-4 px-8 md:px-12 bg-white rounded-3xl">
                <h1 className="text-center pb- text-left text-3xl xl:text-5xl font-heading font-medium">
                  Your WishList
                </h1>
                {carttotal > 0 ? (
                  <span className="inline-block mb-4 text-darkBlueGray-300 font-medium">
                    3 products
                  </span>
                ) : (
                  ""
                ...
                <div className="xl:px-10">
                  {productdetails
                    ...
                    : ""}
                  <div className="hidden w-1/6 text-center bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
              ...
              {carttotal > 0 ? (
                ...
                <>
                  ...
                  <div className="flex items-center justify-center lg:space-x-5 px-8  bg-white rounded-3xl">
                    <h1 className="mb-7 lg:pl-24 md:mt-6 lg:text-3xl md:text-xl md:pt-0 pt-4 text-lg font-heading font-medium">
                      No items in your wishlist at the moment.
                    </h1>
            ...
            <div className="w-full md:w-4/12 xl:w-3/12 px-4">
              <div className="mb-14">
                <h2 className="mb-7 pl-24 md:mt-6 text-3xl font-heading font-medium">
                  Wishlist total
                </h2>
                ...
                <div onClick={() => AddToCartList()}>
                  <Link href="/Cart">
                    <a
                      className="inline-block w-full lg:ml-20 lg:w-auto py-2 px-10 text-xl leading-6 text-white font-medium tracking-tighter font-heading text-center bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl"
                      href="#"
                    >
                      Add all to cart
                    </a>
              ...
              <div className="text-center md:text-left">
                <img
                  ...
                  alt=""
                />
                <h4 className="mb-5 text-5xl font-heading font-medium">
                  Shipping
                </h4>
                <p className="lg:pr-10 text-lg text-darkBlueGray-300">
