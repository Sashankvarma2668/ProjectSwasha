      ...
      <div>
        <section class="py-20 bg-indigo-100">
          <div class="container max-w-6xl mx-auto">
            {courses ? (
              <>
                <h2 class="text-4xl font-bold tracking-tight text-center">Chapters</h2>
                {/* <p class="mt-2 text-lg text-center text-gray-600">Check out our list of courses below.</p> */}
              </>
            ) : (
              ""
            )}
            <div class="p-4 grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
              {courses ? (
                courses.map((course) => {
                  return (
                    <a class="duration-150 hover:scale-105 transform cursor-pointer hover:shadow-2xl relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 rounded-xl text-gray-700 hover:text-nirmaan">
