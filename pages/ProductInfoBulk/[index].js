...
import ProductInProductInfoPage from "../../components/ProductInProductInfoPageBulk";
    ...
    <>
      ...
      <div className="">
        <section className="py-24 xl:py-44  overflow-hidden">
          <div className="container py-16 bg-gray-100 lg:px-24 px-4 mx-auto">
            ...
            <div className="flex items-center justify-center -mx-4">
              ...
              <div className="w-auto sm:w-1/12">
                <a
                  className="inline-block hover:text-darkBlueGray-400"
                  href="#"
                >
                  <svg
                    width="8"
