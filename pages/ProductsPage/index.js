...
import ProductInProductsPage from "../../components/ProductInProductsPage";
              ...
              <div className="md:flex-1 sm:flex sm:flex-wrap mb-10 xl:mb-24 rounded-3xl ">
                <div className="px-4 py-4 border-solid border-2 border-gray-100 bg-gray-100 rounded-3xl lg:block hidden w-full md:w-1/3 lg:w-4/12 xl:w-3/12 mb-10 md:mb-0">
                  <div className="p-10 xl:p-4 xl:pt-10 mb-6 bg-white rounded-3xl">
                    <h2 className="mb-8 text-3xl leading-9 font-heading font-medium">
                      Category
                    </h2>
                    <button
                      onClick={() => categoryChange("")}
                      className="block mb-5 font-heading font-medium"
                    >
                      All Products
                    </button>
                    <a
                      className="flex items-center justify-between mb-5 font-heading font-medium"
                      href="#"
                    >
                      <button
                        className="font-semibold"
                        onClick={() => categoryChange("Earrings")}
                      >
                        Earrings
                      </button>
                    ...
                    >
                      <button
                        className="font-semibold"
                        onClick={() => categoryChange("Vegetable Bags")}
                      >
                        Vegetable Bags
                      </button>
                      <span className="text-sm text-gray-300">267</span>
                    ...
                    >
                      <button
                        className="font-semibold"
                        onClick={() => categoryChange("Bangle Stand")}
                      >
                        Bangle Stand
                      </button>
                    ...
                    >
                      <button
                        className="font-semibold"
                        onClick={() => categoryChange("Hangings")}
                      >
                        Hangings
                      </button>
                    ...
                    <a
                      className="flex items-center justify-between mb-9 font-heading font-medium"
                      href="#"
                    >
                      <button
                        className="font-semibold"
                        onClick={() => categoryChange("Wallet")}
                      >
                        Wallet
                      </button>
                  ...
                  <div className="p-10 px-5 bg-white rounded-3xl">
                    ...
                    <div
                      className="flex items-center py-2 mb-3 leading-8 font-heading font-medium bg-white border border-gray-100 rounded-3xl"
                      href="#"
                    >
                      <input
                        type="radio"
                      ...
                      <label for="vehicle1">
                        {" "}
                        <span className="pl-4">All locations</span>
                      </label>
                    </div>
                    ...
                    >
                      ...
                      <label for="vehicle1">
                        {" "}
                        <span className="pl-4">Fatehnagar</span>
                      </label>
                    </div>
                    <div
                      className="flex items-center py-2 mb-3 leading-8 font-heading font-medium bg-white border border-gray-100 rounded-3xl"
                    ...
                    >
                      ...
                      <label for="vehicle1">
                        {" "}
                        <span className="pl-4">Borabanda</span>
                      </label>
                    </div>
                    <div
                      className="flex items-center py-2 mb-3 leading-8 font-heading font-medium bg-white border border-gray-100 rounded-3xl"
                    ...
                    >
                      ...
                      <label for="vehicle1">
                        {" "}
                        <span className="pl-4">Pilani</span>
                      </label>
                    </div>
                    ...
                    >
                      ...
                      <label for="vehicle1">
                        {" "}
                        <span className="pl-4">Goa</span>
                      </label>
                    </div>

                    {/* <div className="flex items-center py-4 mb-3 leading-8 font-heading font-medium bg-white border border-gray-100 rounded-3xl" href="#">
                    <input type="checkbox" value="Fatehnagar" />
                    <label for="vehicle1"> <span className='pl-4'>Fatehnagar</span></label>
                ...
                <div className="w-full border-red-600 md:w-full lg:w-8/12 xl:w-9/12 md:pl-2">
                  <div className="grid xl:grid-cols-4 gap-0 md:grid-cols-3 grid-cols-1  border-red-600">
                    {data
                      ? data.map((data, key) => (
                          <div key={data.ID}>
